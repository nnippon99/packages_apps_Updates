...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/nnippon99/PixelOS_veux/main/thirteen/veux.json";
    static final String MAINTAINER_URL = "https://github.com/nnippon99";
    static final String DOWNLOAD_WEBPAGE_URL = "https://sourceforge.net/projects/nippongsi/files/Builds/";
    static final String EXPORT_PATH = "PixelOS_veux/";
}
